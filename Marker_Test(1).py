...
def deformface():
    ...
    if all_rows > 0 and recstart == 1:
        ...
        pm.move(float(dataarray[6])*-1 + L_LowerLipMid_X, float(dataarray[7])*-1 + L_LowerLipMid_Y, float(dataarray[8])*-1 + L_LowerLipMid_Z, 'L_LipsBottom_CTRL', relative=True, objectSpace=True, worldSpaceDistance=True )
        ...
        pm.move(float(dataarray[9])*-1 + L_UpperLipMid_CTRL_X, float(dataarray[10])*-1 + L_UpperLipMid_CTRL_Y, float(dataarray[11])*-1 + L_UpperLipMid_CTRL_Z, 'L_LipsTop_CTRL', relative=True, objectSpace=True, worldSpaceDistance=True )
        ...
        pm.move(float(dataarray[12])*-1 + R_LowerLipMid_CTRL_X, float(dataarray[13])*-1 + R_LowerLipMid_CTRL_Y, float(dataarray[14])*-1 + R_LowerLipMid_CTRL_Z, 'R_LipsBottom_CTRL', relative=True, objectSpace=True, worldSpaceDistance=True )
        ...
        pm.move(float(dataarray[15])*-1 + R_UpperLipMid_CTRL_X, float(dataarray[16])*-1 + R_UpperLipMid_CTRL_Y, float(dataarray[17])*-1 + R_UpperLipMid_CTRL_Z, 'R_LipsTop_CTRL', relative=True, objectSpace=True, worldSpaceDistance=True )
