...
std::string transMelCmd(std::string name, Point2f pos) {
    //FULKOD! borde kanske basera skalning p?n?ot annat, typ ansiktsbredd ist?let f? att bara dela med godtyckligt tal? kanske g?a det m?ligt att v?ja f? olika delar av ansiktet?
    // Ja tack!
    //Provar att s?ta vikter i mel-scriptet!
    float modifier = 1.4;
